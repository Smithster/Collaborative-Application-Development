...
def initDatabase():
    ...
    data1 = pd.DataFrame(data=pd.read_csv("ORG01-01082021-31072022.csv"))
    data2 = pd.DataFrame(data=pd.read_csv("ORG02-24112017-25012023.csv"))
    data3 = pd.DataFrame(data=pd.read_csv("ORG03-24112017-25012023.csv"))
